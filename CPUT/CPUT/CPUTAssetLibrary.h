...
public:
    ...
    CPUTMaterial         *GetMaterial(        const cString &name, bool nameIsFullPathAndFilename=false, const cString &modelSuffix=_L(""), const cString &meshSuffix=_L(""), char **pShaderMacros=NULL, int numSystemMaterials=0, cString *pSystemMaterialNames=NULL );
