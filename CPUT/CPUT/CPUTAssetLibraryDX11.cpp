...
CPUTResult CPUTAssetLibraryDX11::GetPixelShader(
    ...
    D3D_SHADER_MACRO      *pShaderMacros
)
{
    ...
    *ppPixelShader = CPUTPixelShaderDX11::CreatePixelShader( finalName, pD3dDevice, shaderMain, shaderProfile, pShaderMacros );
...
)
{
    ...
    *ppComputeShader = CPUTComputeShaderDX11::CreateComputeShader( finalName, pD3dDevice, shaderMain, shaderProfile, pShaderMacros );
...
)
{
    ...
    *ppVertexShader = CPUTVertexShaderDX11::CreateVertexShader( finalName, pD3dDevice, shaderMain, shaderProfile, pShaderMacros );
    ...
    )
{
    ...
    *ppGeometryShader = CPUTGeometryShaderDX11::CreateGeometryShader( finalName, pD3dDevice, shaderMain, shaderProfile, pShaderMacros );
    ...
    )
{
    ...
    *ppHullShader = CPUTHullShaderDX11::CreateHullShader( finalName, pD3dDevice, shaderMain, shaderProfile, pShaderMacros );
    ...
    )
{
    ...
    *ppDomainShader = CPUTDomainShaderDX11::CreateDomainShader( finalName, pD3dDevice, shaderMain, shaderProfile, pShaderMacros );
...
#endif
    *ppShader = CPUTPixelShaderDX11::CreatePixelShaderFromMemory( name, pD3dDevice, shaderMain, shaderProfile, pShaderSource, pShaderMacros);
    return CPUT_SUCCESS;
}
...
)
{
    ...
    ASSERT( NULL == pShader, _L("Shader already exists.") );
#endif
    *ppShader = CPUTVertexShaderDX11::CreateVertexShaderFromMemory( name, pD3dDevice, shaderMain, shaderProfile, pShaderSource, pShaderMacros );
    return CPUT_SUCCESS;
}
...
)
{
    ...
    ASSERT( NULL == pShader, _L("Shader already exists.") );
#endif
    *ppShader = CPUTComputeShaderDX11::CreateComputeShaderFromMemory( name, pD3dDevice, shaderMain, shaderProfile, pShaderSource, pShaderMacros );
    return CPUT_SUCCESS;
}
...
)
{
    ...
    // Prepare the macros
    int macroCount = 0;
    D3D_SHADER_MACRO *pTmp = pShaderMacros;
    if( pTmp )
    {
    ...
    ASSERT( macroCount<(MAX_DEFINES-3), _L("Too many shader macros.") );
    ...
    D3D_SHADER_MACRO pAdditionalMacros[] = {
        { "_CPUT", "1" },
