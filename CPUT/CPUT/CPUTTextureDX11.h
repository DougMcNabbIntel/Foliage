...
public:
    ...
    static CPUTTexture   *CreateTextureArrayFromFilenameList( CPUTRenderParametersDX &renderParams, cString &name, cString **pFilenameList, bool loadAsSRGB );
    ...
    static CPUTResult     CreateNativeTextureFromFile(
    ...
    CPUTTextureDX11() :
        ...
        CPUTTexture()
    {}
    CPUTTextureDX11(const cString &name, UINT numArraySlices=1) :
        mpShaderResourceView(NULL),
        mpTexture(NULL),
        mpTextureStaging(NULL),
        CPUTTexture(name, numArraySlices)
    {}
    CPUTTextureDX11(const cString &name, ID3D11Resource *pTextureResource, ID3D11ShaderResourceView *pSrv, UINT numArraySlices=1 ) :
        mpTextureStaging(NULL),
        CPUTTexture(name, numArraySlices)
    {
    ...
    CPUTResult CreateNativeTexture(
                    ID3D11Device *pD3dDevice,
                    const cString &fileName,
